...
class PublicBlgCleaningTipController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOMeta::setTitle($configuration->global_meta_title . ' | Cleaning Tips');
        ...
        return view('frontend.blog-cleaning-tips')->withSocials($socials)->withConfiguration($configuration);
    }
}