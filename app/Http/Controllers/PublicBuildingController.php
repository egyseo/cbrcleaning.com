...
class PublicBuildingController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOMeta::setTitle($configuration->global_meta_title . ' | Building Mantenaince');
        ...
        return view('frontend.services.building')->withSocials($socials)->withConfiguration($configuration);
    }
}