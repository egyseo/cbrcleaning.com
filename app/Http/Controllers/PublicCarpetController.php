...
class PublicCarpetController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOMeta::setTitle($configuration->global_meta_title . ' | Carpet Cleaning');
        ...
        return view('frontend.services.carpet')->withSocials($socials)->withConfiguration($configuration);
    }
}