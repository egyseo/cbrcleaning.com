...
class PublicChurchController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOMeta::setTitle($configuration->global_meta_title . ' | Church Cleaning');
        ...
        return view('frontend.services.church')->withSocials($socials)->withConfiguration($configuration);
    }
}