...
class PublicIndustrialController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOMeta::setTitle($configuration->global_meta_title . ' | Industrial Cleaning');
        ...
        return view('frontend.services.industrial')->withSocials($socials)->withConfiguration($configuration);
    }
}