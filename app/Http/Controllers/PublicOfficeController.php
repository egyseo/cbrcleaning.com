...
class PublicOfficeController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOMeta::setTitle($configuration->global_meta_title . ' | Office Cleaning');
        ...
        return view('frontend.services.office')->withSocials($socials)->withConfiguration($configuration);
    }
}