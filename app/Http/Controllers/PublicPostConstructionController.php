...
class PublicPostConstructionController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOMeta::setTitle($configuration->global_meta_title . ' | PostConstruction Cleaning');
        ...
        return view('frontend.services.postconstruction')->withSocials($socials)->withConfiguration($configuration);
    }
}