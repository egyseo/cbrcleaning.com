...
class PublicPressureController extends Controller
{
    ...
    public function index()
    {
        ...
        SEOMeta::setTitle($configuration->global_meta_title . ' | Pressure Cleaning Services');
        ...
        return view('frontend.services.pressure')->withSocials($socials)->withConfiguration($configuration);
    }
}