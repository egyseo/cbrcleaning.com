        ...
        <div id="app">
            <div class="login-box">
                ...
                <div class="login-box-body">
                    ...
                    <form action="{{ url('/administrator/password/email') }}" method="post">
                    ...
                    <a href="{{ url('/administrator/login') }}">Log in</a><br>
                    <a href="{{ url('/administrator/register') }}" class="text-center">{{ trans('message.registermember') }}</a>
                </div>
            </div>
        </div>
